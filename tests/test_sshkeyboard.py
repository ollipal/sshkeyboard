...
def press_listen_async(key):
    try:
        listen_keyboard_async(empty, empty)
        print("FAIL")
    except AssertionError:
        print("SUCCESS")
    stop_listening()
...
listen_keyboard_async(returns_a, empty)
print("listen_keyboard_async releasing 'a' returns 'a'")
listen_keyboard_async(empty, returns_a)
...
listen_keyboard_async(press_listen, empty)
print("listen_keyboard_async inside listen_keyboard_async fails")
listen_keyboard_async(press_listen_async, empty)
